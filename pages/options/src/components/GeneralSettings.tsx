        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-sm font-normal ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                {t('options_general_enableVision_desc')} (Always enabled)
              </p>
            </div>
            <div className="relative inline-flex items-center opacity-75 cursor-not-allowed">
              <input id="useVision" type="checkbox" checked={true} disabled={true} className="peer sr-only" />
              <label
                htmlFor="useVision"
                className="peer h-6 w-11 rounded-full bg-blue-600 after:absolute after:left-[2px] after:top-[2px] after:size-5 after:rounded-full after:border after:border-white after:bg-white after:translate-x-full after:border-white after:content-[''] cursor-not-allowed">
                <span className="sr-only">{t('options_general_enableVision')} - Always Enabled</span>
              </label>
            </div>
          </div>
